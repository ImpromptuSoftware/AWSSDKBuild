...
cmake ^
	...
	-DCMAKE_INSTALL_BINDIR=%outputPath%/%buildType%/%abi%/bin ^
	-DCMAKE_INSTALL_LIBDIR=%outputPath%/%buildType%/%abi%/lib ^
	-DCMAKE_INSTALL_INCLUDEDIR=%outputPath%/%buildType%/%abi%/include ^
	-DENABLE_TESTING=0 ^
